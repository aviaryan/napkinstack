...
- `src/data/` is the only place for bands, recipes, instance sizes, prices, and named presets. Do not inline those constants in the UI. Fleet target, replica cap, cache-node budget, and CDN offload defaults live there too.
